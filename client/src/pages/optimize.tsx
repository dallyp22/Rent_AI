    ...
    <div className="space-y-6" data-testid="optimize-page">
      ...
      <div className="bg-card rounded-lg border border-border p-6">
        ...
        {optimizationQuery.data ? (
          <>
            {/* Display warning if no competitor data available */}
            {optimizationQuery.data.report.marketInsights?.marketDataQuality === 'No competitor data available' && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-4" data-testid="no-competitor-warning">
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-semibold text-yellow-800 mb-1">No Market Comparison Data</h3>
                    <p className="text-yellow-700 text-sm">
                      Pricing optimization requires competitor data for market comparison. Current prices are being maintained (0% adjustment) for all units.
                    </p>
                    <p className="text-yellow-700 text-sm mt-1">
                      To get pricing recommendations, please add competitor properties in the Property Selection step.
                    </p>
                  </div>
                </div>
              </div>
